 ...
 * Requires at least Arduino 1.0.5
 * Modified by J.Kedra jurek.kedra@gmail.com
 *
...
class ModbusSlave {
private:
  HardwareSerial&  mySerialPort;  //C++ references
  unsigned char    slave;
  char             txenpin;
 ...
 */
  void configure(char txenpin, unsigned char slave, long baud, uint8_t parity);
